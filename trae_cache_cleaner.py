...
if __name__ == '__main__':
    ...
    if use_gui and HAS_PYQT5:
        run_gui()
    elif use_cli or not HAS_PYQT5:
        if not HAS_PYQT5 and not use_cli:
